                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const Padding(
                        ...
                        child: Text('Fay Al-Mutairi  •  Information Technology  •  Saudi Arabia'),
                      ),
                    ],
                  ),
                ),
      ...
      builder: (context, constraints) {
        ...
        final text = Column(
          ...
          children: [
            ...
            const Text(
              'IT graduate focused on data analytics, Flutter development and practical AI. My work combines hands-on training with projects built around real interfaces, datasets, APIs and software solutions.',
              style: TextStyle(
                fontSize: 18,
                height: 1.6,
                color: Color(0xFF504A43),
              ),
            ),
        ...
        final image = Container(
          height: stacked ? 350 : 480,
          decoration: BoxDecoration(
            border: Border.all(color: const Color(0xFF171717)),
          ),
          child: Image.asset('assets/IMG_6645.PNG', fit: BoxFit.cover),
        );

        if (stacked) {
          return Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [text, const SizedBox(height: 38), image],
          );
        }
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: const BoxDecoration(
        border: Border(bottom: BorderSide(color: Color(0xFFBDB4A8))),
      ),
      child: LayoutBuilder(
        builder: (context, constraints) {
          ...
          if (compact) {
            return Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [text, const SizedBox(height: 20), certificate],
            );
          }
          ...
          return Row(
            ...
            children: [
              ...
              Expanded(flex: 3, child: certificate),
            ],
          );
        },
      ),
...
class _ProjectsState extends State<_Projects> {
  ...
  static const items = [
    _Project(
      ...
      'AI',
      'Graduation Project',
      'A wellbeing application and AI-focused graduation project designed around emotion understanding and supportive user experiences. The interfaces include mood check-ins, habit tracking, breathing exercises, community support, and interaction through voice or camera. The AI work explored multimodal emotion recognition using audio, facial and video inputs and datasets including RAVDESS and MELD.',
      ['AI', 'Deep Learning', 'Flutter', 'Emotion Recognition'],
      ['assets/projects/anees-1.png', 'assets/projects/anees-2.png', 'assets/projects/anees-3.png', 'assets/projects/anees-4.png', 'assets/projects/anees-5.png'],
    ),
    _Project(
      'Weather Dashboard',
      'Data Analytics',
      'API • Dashboard',
      'A weather dashboard connected to an API and refreshed periodically. It presents current conditions, multi-day forecasts, humidity, wind speed, visibility, pressure, UV index, precipitation, sunrise/sunset and air-quality indicators in one visual view.',
      ['API', 'Dashboard', 'Data Visualization'],
    ...
    _Project(
      ...
      'Data Analytics',
      'Business Analytics',
      'A clean sales dashboard created to demonstrate analysis and visualization skills through KPIs, sales and revenue comparisons, customers, product performance, trends and weekly category views.',
      ['Power BI', 'KPIs', 'Sales Analytics'],
      ['assets/projects/sales.jpg'],
    ),
    _Project(
      'COVID-19 Dashboard',
      'Data Analytics',
      'Tableau • Large Dataset',
      'Built from a large COVID-19 dataset in Tableau to explore deaths by continent, population infection percentages, country comparisons, geographic distribution and overall cases and deaths.',
      ['Tableau', 'Large Dataset', 'Analytics'],
    ...
    _Project(
      ...
      'Flutter & Mobile',
      'Flutter',
      'A simple real-estate mobile application with property browsing, search and filters. Users can browse houses, villas and apartments and narrow listings through a straightforward mobile interface.',
      ['Flutter', 'Mobile', 'Filters'],
      ['assets/projects/realestate-1.png', 'assets/projects/realestate-2.png'],
    ),
    _Project(
      'Graduation Projects Platform',
      'Flutter & Mobile',
      'Flutter Web',
      'A Flutter Web platform created as a dedicated space for students to showcase graduation projects. Students submit their projects through a structured form, making project sharing and discovery more organized.',
      ['Flutter Web', 'Forms', 'UI/UX'],
      ['assets/projects/gradplatform.png'],
    ),
    _Project(
      'Kharja',
      'Flutter & Mobile',
      'Mobile Application',
      'A mobile application project developed around planning outings and nearby activities. The interface includes creating a new outing, adding a cover image, title and description, and selecting categories such as sports, food, music, gaming, arts and culture.',
      ['Flutter', 'Mobile Development', 'UI/UX'],
      ['assets/projects/kharja-1.png', 'assets/projects/kharja-2.png'],
    ),
    _Project(
      'Library Database Schema',
      'Web & Database',
      'Database Design',
      'A database-design project for a university library system focused on entities, relationships and organized information structure.',
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        const Text(
          'Browse by area. Open a project to see the full description, skills and images.',
          style: TextStyle(fontSize: 16, height: 1.6, color: Color(0xFF5A544D)),
        ),
        const SizedBox(height: 18),
        Wrap(
          spacing: 9,
          ...
          children: filters.map((e) {
            return ChoiceChip(
              ...
              labelStyle: TextStyle(color: filter == e ? Colors.white : const Color(0xFF171717)),
            );
          }).toList(),
        ),
        ...
        LayoutBuilder(
          builder: (context, constraints) {
            ...
            return Wrap(
              spacing: 20,
              runSpacing: 20,
              children: shown.map((p) => SizedBox(width: width, child: _ProjectCard(p))).toList(),
            );
          },
        ),
      ],
    ...
    return Material(
      ...
      child: InkWell(
        onTap: () => Navigator.of(context).push(
          MaterialPageRoute(builder: (_) => _ProjectDetails(project)),
        ),
        child: Container(
          decoration: BoxDecoration(
            border: Border.all(color: const Color(0xFFBDB4A8)),
          ),
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  Text(
                    project.category.toUpperCase(),
                    style: const TextStyle(fontSize: 12, fontWeight: FontWeight.w800, letterSpacing: 1.8),
                  ),
                  const SizedBox(height: 12),
                  Text(
                    project.title,
                    style: const TextStyle(fontSize: 48, height: 1, fontWeight: FontWeight.w900, letterSpacing: -1.5),
                  ),
                  const SizedBox(height: 10),
                  Text(
                    project.type,
                    style: const TextStyle(fontSize: 17, color: Color(0xFF6C655D), fontWeight: FontWeight.w700),
                  ),
                  const SizedBox(height: 28),
                  Text(
                    project.description,
                    style: const TextStyle(fontSize: 18, height: 1.75, color: Color(0xFF413C36)),
                  ),
                  const SizedBox(height: 24),
                  ...
                  if (project.images.isNotEmpty) ...[
                    ...
                    _DetailsGallery(project.images),
                  ],
                ],
              ),
            ),
    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        if (images.length == 1) {
          return Center(
            child: ConstrainedBox(
              constraints: const BoxConstraints(maxHeight: 520, maxWidth: 900),
              child: Container(
                width: double.infinity,
        ...
        final height = mobile ? 300.0 : 300.0;
...
class _Tag extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(border: Border.all(color: const Color(0xFF8E857A))),
...
class _Skills extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return const Wrap(
      ...
      runSpacing: 35,
      children: [
        _Skill('Data Analytics', ['Power BI', 'Tableau', 'Excel', 'Python', 'SQL', 'Data Cleaning', 'KPI Reporting']),
        _Skill('Development', ['Flutter', 'Flutter Web', 'Dart', 'Firebase', 'Git', 'APIs']),
        _Skill('AI & Database', ['Machine Learning', 'Deep Learning', 'Emotion Recognition', 'Database Design', 'Data Modeling']),
      ],
    );
  }
}
...
class _Skill extends StatelessWidget {
  ...
  const _Skill(this.title, this.items);
...
class _Contact extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return const Column(
      ...
      children: [
        Text(
          'Open to opportunities in data analytics, application development and practical technology projects.',
          style: TextStyle(fontSize: 25, height: 1.45, fontWeight: FontWeight.w800),
        ),
        SizedBox(height: 28),
        _ContactLine('Phone', '0530460609'),
        _ContactLine('Email', 'fayalmtuairi@gmail.com'),
        _ContactLine('GitHub', 'github.com/FayAL-mtuairi'),
        _ContactLine('LinkedIn', 'linkedin.com/in/fay-al-mutairi-834a4a246'),
      ],
    );
  }
}
...
class _ContactLine extends StatelessWidget {
  ...
  const _ContactLine(this.label, this.value);
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Wrap(
        spacing: 18,
        children: [
          SizedBox(width: 85, child: Text(label, style: const TextStyle(fontWeight: FontWeight.w800))),
